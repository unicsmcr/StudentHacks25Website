...
const Navbar = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 mt-12 z-50 flex justify-center shadow-2xl text-sm">
      <div className="bg-transparent backdrop-blur-3xl outline-primary outline-2 shadow-md py-4 px-3 rounded-2xl">
        <ul className="flex space-x-2 font-title font-bold">
